        ...
        <div className="text-center space-y-8">
          <div className="space-y-6">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-light">
              Transform your photo gallery into an intelligent storybook with AI-powered suggestions, rich text notes, and multilingual support. Every photo becomes a meaningful memory with Notia v1.0.9-Alpha (Pre-Beta).
            </p>
          </div>
